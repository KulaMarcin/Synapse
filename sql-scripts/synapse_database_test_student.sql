...
CREATE TABLE `test_student` (
  ...
  KEY `fk_my_student_01` (`student_id`),
  CONSTRAINT `fk_my_course` FOREIGN KEY (`course_id`) REFERENCES `test` (`id`),
  CONSTRAINT `fk_my_student_01` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`)
