...
CREATE TABLE `teacher_student` (
  ...
  KEY `fk_my_student_011` (`student_id`),
  CONSTRAINT `fk_my_course1` FOREIGN KEY (`instructor_id`) REFERENCES `teacher` (`id`),
  CONSTRAINT `fk_my_student_011` FOREIGN KEY (`student_id`) REFERENCES `student` (`id`)
...
INSERT INTO `teacher_student` VALUES (13,25),(13,26),(13,27);
